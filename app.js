...
function renderOverview() {
  setHeader("لوحة القيادة التنفيذية", "منصة تشغيل مترابطة للتجارة والغذاء والإمداد والمدفوعات والأثر");
  ...
  return `<section class="hero"><div><h3>اكتفاء 3.0: طبقة تشغيل وطنية مترابطة</h3><p>نسخة MVP عامة توضّح كيف تتصل التجارة، المتاجر، المخزون، الإمداد، اللوجستيات، الأسطول، التجار، المدفوعات، الحوكمة، والبرامج الاجتماعية داخل نموذج تشغيلي واحد قابل للفحص.</p><div class="hero-badges"><span>تجارة وغذاء</span><span>متاجر ولوجستيات</span><span>مدفوعات وحوكمة</span><span>أثر قابل للقياس</span></div></div><div class="hero-side"><div class="hero-metric"><strong>103</strong><span>ميزة مسجلة في سجل اكتفاء 3.0</span></div><div class="hero-metric"><strong>10</strong><span>نطاقات تشغيل مترابطة</span></div><div class="hero-metric"><strong>6</strong><span>سيناريوهات عرض تنفيذية</span></div></div></section>
