...
const csvColumns = [
  ...
  ["functionalValidationStatus", "التحقق الوظيفي"],
  ["functionalValidationReference", "مرجع التحقق الوظيفي"],
...
const markdownColumns = [
  ...
  ["displayPath", "مسار العرض"],
  ["testReference", "مرجع الاختبار"],
  ["functionalValidationLabel", "التحقق الوظيفي"],
  ["verificationLabel", "حالة التحقق"],
  ["nextEvidence", "الدليل التالي المطلوب"]
];
...
const markdown = [
  ...
  `- الميزات التي اجتازت التحقق الوظيفي المحلي: ${EVIDENCE_MATRIX_STATS.functionalValidationRows}`,
  ...
  "## Interpretation",
  "",
  "الحالة `demonstrated` تعني أن مسار العرض داخل المتصفح قابل لإعادة التشغيل ببيانات اصطناعية، وأن اختبار القبول الخاص به يتحقق من ظهور السجل عبر مسار البحث العام. التحقق الوظيفي المحلي الحالي يغطي F01 إلى F06 ببيانات اصطناعية حتمية، ولا يحول هذه النتيجة إلى إثبات إنتاجي. الحالة `architecture` تعني أن السجل يصف قدرة معمارية ولم تُثبت كخدمة منفذة في هذه النسخة العامة. الحالة `reserved` تحفظ السجل التاريخي أو الدمج ولا تدخل في عدّاد الميزات المعرفة.",
  "",
